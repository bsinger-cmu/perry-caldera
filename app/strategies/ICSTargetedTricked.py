...
class LogicalPlanner:
    def __init__(
        ...
        self.criticalSubnet = Subnet("192.168.201.0/24")
        self.criticalHostNames = "decoy-control-host"
    ...
    def choose_attack_path(self):
        ...
        for attack_path in self.attack_path_queue:
            if attack_path.target_host.hostname:
                if self.criticalHostNames in attack_path.target_host.hostname:
                    # fmt: off
            ...
            if attack_path.attack_technique.CredentialToUse is not None:
                ...
                if (
                    ...
                    or "decoycontrol" in path_hostname.lower()
                ):
                    # fmt: off
